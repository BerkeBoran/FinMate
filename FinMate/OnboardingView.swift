...
//  FinMate
//
//  İlk açılış akışı: Ad/Soyad → Güvenlik tipi → (gerekirse) Şifre belirleme.
//  Bitince onboardingCompleted = true olur ve uygulama MainView'a geçer.
//
...
struct OnboardingView: View {
    /// Akış tamamlandığında dışarıya bildir
    var onComplete: () -> Void
    ...
    // Local draft (commit on next/complete)
    ...
    private func submitSecurity() {
        ...
        if mode.requiresPasscode {
            ...
            // Sadece biyometri — şifre adımı atlanır
